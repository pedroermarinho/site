class ReadmeModel {
  ...
  factory ReadmeModel.fromJson(Map<String, dynamic> json) => ReadmeModel(
        ...
        credits: json['credits'] != null ? <Credits>[] : _setCredits(json['credits']),
...
class Repository {
  ...
  factory Repository.fromJson(Map<String, dynamic> json) => Repository(type: json['type'], url: json['url']);
...
class Credits {
  ...
  factory Credits.fromJson(Map<String, dynamic> json) => Credits(name: json['name'], url: json['url']);
